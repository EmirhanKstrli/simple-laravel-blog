        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.page.edit.post', $page->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <img src="{{ asset($page->image) }}" class="img-thumbnail rounded" width="250" alt="">
                    <input type="file" name="image" class="form-control">
                </div>
                <div class="form-group">
                    <label for="">Makale İçeriği</label>
                    <textarea id="editor" name="content" class="form-control" rows="4" required>{!! $page->content !!}</textarea>
                </div>
                <div class="form-group">
